...
<article class="post card learner-info">
    ...
    <section id="learner-info" class="learner-info entry fix">
        ...
        <?php if(  is_a( $learner_user, 'WP_User' ) ){ ?>
            ...
            ?>
						...
						<?php Sensei()->learner_profiles->learner_profile_courses_heading($learner_user); ?>
            
            <?php

            // show the user courses
            Sensei()->course->load_user_courses_content( $learner_user );
						Sensei()->course->the_course_action_buttons( $learner_user );
            ?>
