...
<article <?php post_class( array( 'lesson', 'post', 'card', 'content-single-lesson' ) ); ?>>
                
    <?php skillfully_single_sensei_header(); // replaces sensei_lesson_image and sensei_lesson_single_title ?>
    <?php
